...
const eventsList = [
 { id: "1", slug: "cybersecurity-workshop-2026", title: "Cybersecurity Workshop: Threat Intelligence for Financial Services", description: "A hands-on workshop on identifying and mitigating cyber threats targeting African financial institutions.", cover_image: "/images/security-ops.jpg", event_type: "Workshop", location_type: "online", location: "Online", start_date: "2026-06-15T09:00:00", end_date: "2026-06-16T17:00:00", max_capacity: 50, is_free: true, registration_open: true, require_approval: false },
 { id: "2", slug: "qkabrine-launch", title: "Qkabrine Platform Launch & Demo", description: "Join us for the public launch of the Qkabrine Quantum ML platform with live demonstrations.", cover_image: "/images/qkabrine.jpg", event_type: "Webinar", location_type: "online", location: "Online", start_date: "2026-07-10T14:00:00", end_date: null, max_capacity: 200, is_free: true, registration_open: true, require_approval: false },
 { id: "3", slug: "data-governance-summit", title: "African Data Governance Summit 2026", description: "A gathering of policymakers, researchers, and practitioners working on data governance frameworks.", cover_image: "/images/team-working.jpg", event_type: "Conference", location_type: "in_person", location: "Accra, Ghana", start_date: "2026-08-20T08:00:00", end_date: "2026-08-22T18:00:00", max_capacity: 150, is_free: false, registration_open: false, require_approval: true },
 { id: "4", slug: "privacy-engineering-bootcamp", title: "Privacy Engineering Bootcamp", description: "Intensive 3-day training on privacy engineering fundamentals for software developers.", cover_image: "/images/about-lab.jpg", event_type: "Training", location_type: "hybrid", location: "Nairobi, Kenya / Online", start_date: "2026-05-10T09:00:00", end_date: "2026-05-12T17:00:00", max_capacity: 30, is_free: false, registration_open: true, require_approval: true },
];
...
export default function Events() {
 ...
 const grouped = display.reduce<Record<string, typeof eventsList>>((acc, e) => {
